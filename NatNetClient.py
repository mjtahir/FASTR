...
class NatNetClient:
    def __init__( self ):
        ...
        # Only "0.0.0.0" worked with Ubuntu, Windows is fine with the local IP (192.168.1.xxx)
    ...
    def __createDataSocket( self, port ):
        ...
        # Allows reconnection to same port even if the socket was closed recently.
